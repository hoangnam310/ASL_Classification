...
def record_webcam_video(output_dir='./recordings'):
    """
    ...
    if restart:
        ...
        return record_webcam_video(output_dir)  # Recursive call to restart
...
if __name__ == "__main__":
    ...
    # Check if we should record a new video
    if args.record:
        print("Starting webcam recording mode...")
        input_video_path = record_webcam_video(args.recordings_dir)
